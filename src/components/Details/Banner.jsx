...
const Banner = ({
  ...
  return (
    <section className={` flex-col mb-14`}>
      ...
      <div className='hidden sd:block absolute w-full h-[350px] ss:h-[680px] bg-black opacity-40 ' />
      ...
      <div className={`${styles.flexCenter} mt-0 md:mt-14`}>
        <div className={`relative w-[90%] banner-grid top-10 md:top-0 z-10`}>
          ...
          <div
            className={`${styles.flexStartX} flex-col p-3 mt-4 sm:mt-10 sd:ml-6 md:ml-0`}
          >
