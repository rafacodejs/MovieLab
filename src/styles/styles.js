const styles = {
  ...
  bannerButton:
    'flex justify-center items-center  w-[100px] h-[30px] xs:w-[100px] sm:w-[150px] ss:h-[30px] sm:h-[40px] bg-transparent rounded-full text-white font-primary font-medium text-[12px] sm:text-[18px] cursor-pointer shadow-5xl border-2 border-primary mt-3 mr-1 ss:mr-3 animation-img',
